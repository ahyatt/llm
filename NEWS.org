* Version 0.32.2
- Add Muse Spark and Muse Spark Contributor models (usable as Open AI compatible model, or with OpenRouter), and add GPT 6 Sol and Luna
- Set default Open AI model to GPT 6 Sol
* Version 0.32.1
- Added tool IDs to Ollama streaming for better context-keeping, by [[https://github.com/yibie][yibie]]
...
- No longer send Open AI reasoning if unset in the =llm-chat-prompt=, by [[https://github.com/isamert][İsa Mert Gürbüz]]
* Version 0.32.0
...
* Version 0.31.2
- Fixed Deepseek streaming tool calling, by [[https://github.com/isamert][İsa Mert Gürbüz]].
* Version 0.31.1
- Fixed Audio API support for Open AI-compatible providers and Ollama providers by [[https://github.com/s-kostyaev][Sergey Kostyaev]]. 
...
- Improved support for Open AI streaming for tool calls, by [[https://github.com/renatofdds][Renato Ferreira]].
